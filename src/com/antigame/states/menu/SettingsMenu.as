package com.antigame.states.menu
{
	...
	public class SettingsMenu extends BaseMenu
	{
		...
		override public function initialize():void{
			...
			add(MenuFactory.createCenteredLabel(this.stage,"titleLabel","SETTINGS MENU", 60, 0x0, true, 200));	
			
			mainMenuButton = MenuFactory.createButton("mainMenuBtn", "MAIN MENU", 0x0, 200, 700);
